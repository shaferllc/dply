 ...
 * the new env vars into its spec (no-op on FakeCloudBackend),
 * then dispatches RedeployCloudSiteJob.
 *
 * Tests run in fake-cloud mode so backend->updateEnvVars() lands
 * on FakeCloudBackend and doesn't try to call DO/AWS.
 */
class CloudEnvEditorTest extends TestCase
{
    use RefreshDatabase;
