 ...
 */
function orgServerAndToken(array $abilities = ['insights.read', 'servers.read']): array
{
...
test('server insights returns open findings', function () {
...
test('org summary includes severity counts and health score', function () {
    [$org, $server, $plain] = orgServerAndToken();
...
test('server insights forbidden for other org', function () {
