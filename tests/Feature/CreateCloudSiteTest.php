...
class CreateCloudSiteTest extends TestCase
{
    use RefreshDatabase;

    public function test_creates_cloud_server_and_site_and_dispatches_provision(): void
    {
        Queue::fake();
        ...
        $this->assertSame(Server::HOST_KIND_DPLY_CLOUD, $site->server->hostKind());
