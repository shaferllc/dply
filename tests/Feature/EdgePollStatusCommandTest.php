...
class EdgePollStatusCommandTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_dispatches_job_per_provisioning_site(): void
    {
        ...
        $exit = Artisan::call('dply:edge:poll-status');

        $this->assertSame(0, $exit);
        Queue::assertPushed(PollEdgeStatusJob::class, 2);
    }
    ...
    public function test_include_active_flag_polls_active_sites_too(): void
    {
        ...
        Artisan::call('dply:edge:poll-status', ['--include-active' => true]);
    ...
    public function test_skips_sites_without_backend_id(): void
    {
        ...
        Artisan::call('dply:edge:poll-status');

        Queue::assertNotPushed(PollEdgeStatusJob::class);
    }
