...
class EdgeLogsCommandTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_returns_signed_url_for_do_site(): void
    {
        ...
        $exit = Artisan::call('dply:edge:logs', ['site' => $site->name]);
    ...
    public function test_returns_inline_content_in_fake_cloud_mode(): void
    {
        ...
        // fake-cloud mode the site goes through FakeEdgeBackend
    ...
    public function test_rejects_non_edge_site(): void
    {
        ...
        $exit = Artisan::call('dply:edge:logs', ['site' => $vmSite->name]);
    ...
    {
        $exit = Artisan::call('dply:edge:logs', ['site' => 'nope']);
