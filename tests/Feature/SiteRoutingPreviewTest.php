...
class SiteRoutingPreviewTest extends TestCase
{
    use RefreshDatabase;

    public function test_save_preview_settings_round_trips(): void
    {
        Bus::fake();
    ...
    public function test_confirm_remove_preview_domain(): void
    {
        Bus::fake();
        [$user, $server, $site] = $this->makeUserSite();
