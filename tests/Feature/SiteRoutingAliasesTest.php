...
class SiteRoutingAliasesTest extends TestCase
{
    use RefreshDatabase;

    public function test_add_alias_with_comment(): void
    {
        Bus::fake();
    ...
    public function test_inline_edit_alias(): void
    {
        Bus::fake();
        [$user, $server, $site] = $this->makeUserSite();
        ...
        $this->assertSame('new.example.com', $alias->fresh()->hostname);
        $this->assertSame('updated', $alias->fresh()->comment);
    }

    public function test_confirm_remove_alias(): void
    {
        Bus::fake();
        [$user, $server, $site] = $this->makeUserSite();
        ...
        $this->assertNull($alias->fresh());
    }

    public function test_bulk_import_aliases_with_label(): void
    {
        Bus::fake();
        [$user, $server, $site] = $this->makeUserSite();
