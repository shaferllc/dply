...
namespace Tests\Feature\InfrastructureDomainsPageTest;
...
test('lists all domains for current org', function () {
    ...
    $response = $this->actingAs($user)->get(route('infrastructure.domains'));
...
test('search narrows to matching hostname', function () {
    ...
    $response = $this->actingAs($user)->get(route('infrastructure.domains').'?q=example');
...
test('primary only filter', function () {
    ...
    $response = $this->actingAs($user)->get(route('infrastructure.domains').'?primary_only=1');
...
test('runtime filter', function () {
    ...
    $response = $this->actingAs($user)->get(route('infrastructure.domains').'?runtime=node');
