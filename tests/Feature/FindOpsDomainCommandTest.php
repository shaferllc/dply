...
namespace Tests\Feature\FindOpsDomainCommandTest;
...
test('finds exact match with site and server context', function () {
    ...
    Artisan::call('dply:ops:domain-find', [
...
test('exits non zero on no matches', function () {
    ...
    $exit = Artisan::call('dply:ops:domain-find', [
...
test('rejects empty hostname', function () {
    $exit = Artisan::call('dply:ops:domain-find', ['hostname' => '']);
