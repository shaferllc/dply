...
class EdgeDoctorCommandTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_reports_healthy_edge_site_with_credential(): void
    {
        ...
        $exit = Artisan::call('dply:edge:doctor', [
            'site' => $site->name,
            '--json' => true,
        ]);
    ...
    {
        $exit = Artisan::call('dply:edge:doctor', ['site' => 'nope']);
    ...
    public function test_fails_when_site_is_not_edge(): void
    {
        ...
        $exit = Artisan::call('dply:edge:doctor', ['site' => $site->name]);
