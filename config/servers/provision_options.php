    ...
    */
    ...
    'server_roles' => [
        ...
        [
            'id' => 'redis',
            'label' => 'Cache / key-value server',
            'detail' => 'Redis-compatible or Memcached engine, UFW',
            'summary' => 'Dedicated cache host for Redis, Valkey, KeyDB, Dragonfly, or Memcached workloads.',
            'installs' => ['Engine of your choice', 'UFW'],
    ...
    'webservers' => [
        [
            'id' => 'nginx',
            'label' => 'NGINX',
            'summary' => 'Recommended default for most PHP and Laravel apps.',
        ...
        [
            ...
            'cons' => ['Heavier default footprint', 'Not our default path for modern Laravel apps'],
        ...
        [
            ...
            'cons' => ['Less standard than NGINX or Apache', 'Fewer teams already know how to operate it'],
            'exclude_server_roles' => ['load_balancer', 'database', 'redis', 'valkey', 'plain', 'worker'],
        ],
        [
            'id' => 'traefik',
    ...
    'databases' => [
        ...
        ['id' => 'postgres18', 'enabled' => true, 'label' => 'PostgreSQL 18', 'exclude_server_roles' => ['load_balancer', 'redis', 'valkey', 'plain']],
        ['id' => 'postgres17', 'enabled' => true, 'label' => 'PostgreSQL 17', 'exclude_server_roles' => ['load_balancer', 'redis', 'valkey', 'plain']],
        ['id' => 'postgres16', 'enabled' => true, 'label' => 'PostgreSQL 16', 'exclude_server_roles' => ['load_balancer', 'redis', 'valkey', 'plain']],
        ['id' => 'postgres15', 'enabled' => true, 'label' => 'PostgreSQL 15', 'exclude_server_roles' => ['load_balancer', 'redis', 'valkey', 'plain']],
        ['id' => 'postgres14', 'enabled' => true, 'label' => 'PostgreSQL 14', 'exclude_server_roles' => ['load_balancer', 'redis', 'valkey', 'plain']],
