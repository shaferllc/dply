...
class RoadmapItemSeeder extends Seeder
{
    ...
    {
        $items = [
            // In progress — product lines and engines still expanding
            [
                'title' => 'dply Edge static delivery',
                'summary' => 'Git-connected JS/static sites with previews, CDN, bindings, and hybrid SSR.',
                'description' => 'First-party Edge hosting on on-dply.site with build → R2 → Worker delivery, preview protection, KV/R2/D1 bindings, hybrid origin-fetch SSR, and usage analytics.',
            ...
            [
                ...
                'description' => 'Skip provider credentials — dply provisions and operates the VM with cost-plus metering. Rolling out behind surface.managed_servers.',
                'status' => RoadmapItem::STATUS_IN_PROGRESS,
                'area' => 'servers',
                'sort_order' => 5,
                'is_published' => true,
            ...
            // Shipped — live capabilities
            [
                'title' => 'Unified workspace chrome',
                'summary' => 'One merged card layout across site, server, Fleet, org, and profile pages.',
                'description' => 'Sand identity headers, flush tabs, and hairline strips replace stacked floating heroes for a calmer enterprise SaaS shell.',
            ...
            [
                ...
                'summary' => 'Create, attach, and detach KV, R2, and D1 bindings for Edge sites in the app.',
                'description' => 'Interactive edge-bindings tab backed by EdgeEffectiveBindings; wrangler.toml remains authoritative.',
                'status' => RoadmapItem::STATUS_SHIPPED,
                'area' => 'edge',
                'sort_order' => 1,
                'is_published' => true,
            ...
            [
                ...
                'summary' => 'Notify when an Edge deploy takes unusually long.',
                'description' => 'duration_regressed alert plus accurate deploy duration tracking.',
                'status' => RoadmapItem::STATUS_SHIPPED,
                'area' => 'edge',
                'sort_order' => 2,
                'is_published' => true,
            ...
            [
                ...
                'description' => 'Hybrid Edge stack auto-provisions Cloud origin when SSR is detected — Phase 4 hybrid origin-fetch path is live.',
                'status' => RoadmapItem::STATUS_SHIPPED,
                'area' => 'edge',
                'sort_order' => 9,
                'is_published' => true,
            ...
            [
                ...
                'description' => 'Caches workspace engine with install guard — cache.valkey product support is live.',
                'status' => RoadmapItem::STATUS_SHIPPED,
                'area' => 'servers',
                'sort_order' => 13,
                'is_published' => true,
            ...
            // Planned — gated or not yet product-ready
            [
    ...
    private function assignReleaseTrains(): void
    {
        ...
        $targets = [
            ...
            'Ops Copilot' => '2026-09',
            'MariaDB database engine' => '2026-09',
            'Hosted WordPress' => '2026-12',
            'Per-site CDN and cache purging' => '2026-12',
        ];

        $shippedTargets = [
            'dply CLI device login' => '2026-05',
            'Browser-based server Console' => '2026-06',
            'Deploy Pipeline workspace' => '2026-06',
            '.dply.yaml repo sync' => '2026-06',
            'Deploy contract gates' => '2026-06',
            'Saved Run commands' => '2026-06',
            'Release hygiene scanner' => '2026-06',
            'SSH security digest' => '2026-06',
            'Health cockpit' => '2026-06',
            'Shared Host Radar' => '2026-06',
            'Deploy windows' => '2026-06',
            'Server maintenance mode' => '2026-06',
            'Server Blueprint capture' => '2026-06',
            'Fleet operations hub' => '2026-07',
            'Remote Files workspace' => '2026-07',
            'Ephemeral deploy credentials' => '2026-07',
            'Full-stack launch wizard' => '2026-07',
            'Cost observatory' => '2026-07',
            'Preview review hub' => '2026-07',
            'Edge SSR hybrid origin' => '2026-07',
            'SSH access graph' => '2026-07',
            'Server-scoped Backups' => '2026-07',
            'Server Insights' => '2026-07',
            'Valkey cache engine' => '2026-07',
            'Unified workspace chrome' => '2026-07',
            'Edge Bindings dashboard' => '2026-07',
            'Edge deploy duration alerts' => '2026-07',
        ];
