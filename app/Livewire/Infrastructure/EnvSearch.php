...
/**
 * Browser view of dply:ops:env-find. Searches every site's env cache by
 ...
 * regresses on very large orgs, follow up with a `site_env_keys` index
 * table.
 *
...
class EnvSearch extends Component
{
    ...
    public function render(DotEnvFileParser $parser): View
    {
        ...
        return view('livewire.infrastructure.env-search', [
            'rows' => $rows,
            'hasQuery' => $this->query !== '',
        ])->layout('layouts.app');
    }
