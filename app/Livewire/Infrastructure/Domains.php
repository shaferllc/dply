...
/**
 * Org-wide domain inventory. Browser view of dply:ops:domain-list
 * with a search input that mirrors dply:ops:domain-find --contains.
 *
...
class Domains extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('livewire.infrastructure.domains', [
            'rows' => $rows,
            'runtimes' => $runtimes,
        ])->layout('layouts.app');
    }
