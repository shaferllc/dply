...
/**
 * Combined org-wide deploy activity dashboard. Three tabs:
 *
 ...
 *
 * Mirrors the equivalent dply:ops:running-deploys / failed-deploys /
...
class Deploys extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('livewire.infrastructure.deploys', [
            'rows' => $rows,
            'counts' => $counts,
        ])->layout('layouts.app');
    }
