...
use App\Services\Infrastructure\UnifiedPreviewCatalog;
...
/**
 * Org-wide managed preview hostname inventory — BYO testing hostnames and
...
class Previews extends Component
{
    ...
    public function render(UnifiedPreviewCatalog $catalog): View
    {
        ...
        return view('livewire.infrastructure.previews', [
            'rows' => $rows,
