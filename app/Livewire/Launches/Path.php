        ...
        return [
            ...
            'kubernetes' => [
                ...
                'items' => [
                    ...
                    [
                        'title' => __('Container launcher'),
                        'description' => __('Use the same repo-first workflow to land a Kubernetes target via the shared container launcher.'),
                        'href' => route('launches.containers.create'),
                        'cta' => __('Open container launcher'),
                    ],
                ],
            ],
            'cloud-network' => [
