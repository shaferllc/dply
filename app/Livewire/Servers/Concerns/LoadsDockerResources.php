    ...
    private function loadRemoteList(string $tab): void
    {
        ...
        match ($tab) {
            'containers' => $this->withRemoteLoad(
                ...
                empty: function (): void { $this->containers = []; },
            ),
            'images' => $this->withRemoteLoad(
                ...
                empty: function (): void { $this->images = []; },
            ),
            'volumes' => $this->withRemoteLoad(
                ...
                empty: function (): void { $this->volumes = []; },
            ),
            'networks' => $this->withRemoteLoad(
                ...
                empty: function (): void { $this->networks = []; },
            ),
            'compose' => $this->withRemoteLoad(
                ...
                empty: function (): void { $this->composeProjects = []; },
            ),
            'maintenance' => $this->withRemoteLoad(
                ...
                empty: function (): void { $this->systemDf = []; },
            ),
            default => null,
        };
    }
