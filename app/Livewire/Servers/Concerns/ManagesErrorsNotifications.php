...
trait ManagesErrorsNotifications
{
    ...
    {
        return ServerErrorsNotificationKeys::eventKeys();
    }
    ...
    /**
     * server.errors.* event keys ticked in the add form. Seeded to all of them so
    ...
    public function mountManagesErrorsNotifications(): void
    {
        ...
        $this->notif_event_keys = ServerErrorsNotificationKeys::eventKeys();
    }
    ...
    public function addErrorsNotificationSubscription(): void
    {
        ...
        $allowedKeys = ServerErrorsNotificationKeys::eventKeys();
    ...
    public function removeErrorsNotificationSubscription(string $subscriptionId): void
    {
        ...
        $sub = NotificationSubscription::query()
            ...
            ->whereIn('event_key', ServerErrorsNotificationKeys::eventKeys())
