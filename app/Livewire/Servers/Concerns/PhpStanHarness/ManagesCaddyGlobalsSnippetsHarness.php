...
use App\Livewire\Servers\Concerns\ManagesCaddyGlobalsSnippets;

/** @internal PHPStan harness for ManagesCaddyGlobalsSnippets */
final class ManagesCaddyGlobalsSnippetsHarness extends Component
{
