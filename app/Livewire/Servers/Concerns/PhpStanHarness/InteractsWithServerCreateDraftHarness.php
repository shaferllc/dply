...
/** @internal PHPStan harness for InteractsWithServerCreateDraft */
final class InteractsWithServerCreateDraftHarness extends Component
{
    use InteractsWithServerCreateDraft;
    protected function stepNumber(): int { return 1; }
