...
use App\Livewire\Servers\Concerns\ManagesTraefikCore;

/** @internal PHPStan harness for ManagesTraefikCore */
final class ManagesTraefikCoreHarness extends Component
{
