...
use App\Livewire\Servers\Concerns\ManagesCaddyModules;

/** @internal PHPStan harness for ManagesCaddyModules */
final class ManagesCaddyModulesHarness extends Component
{
