...
use App\Livewire\Servers\Concerns\ManagesTraefikUdpHttpServices;

/** @internal PHPStan harness for ManagesTraefikUdpHttpServices */
final class ManagesTraefikUdpHttpServicesHarness extends Component
{
