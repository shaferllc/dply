...
use App\Livewire\Servers\Concerns\ManagesCacheStatusModal;

/** @internal PHPStan harness for ManagesCacheStatusModal */
final class ManagesCacheStatusModalHarness extends Component
{
