...
use App\Livewire\Servers\Concerns\RunsCacheServiceActions;

/** @internal PHPStan harness for RunsCacheServiceActions */
final class RunsCacheServiceActionsHarness extends Component
{
