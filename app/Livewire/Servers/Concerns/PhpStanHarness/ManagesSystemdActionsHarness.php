...
use App\Livewire\Servers\Concerns\ManagesSystemdActions;

/** @internal PHPStan harness for ManagesSystemdActions */
final class ManagesSystemdActionsHarness extends Component
{
