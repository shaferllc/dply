...
use App\Livewire\Servers\Concerns\ManagesSystemdActionBanner;

/** @internal PHPStan harness for ManagesSystemdActionBanner */
final class ManagesSystemdActionBannerHarness extends Component
{
