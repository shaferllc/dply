...
use App\Livewire\Servers\Concerns\ManagesTraefikEntrypointsTcp;

/** @internal PHPStan harness for ManagesTraefikEntrypointsTcp */
final class ManagesTraefikEntrypointsTcpHarness extends Component
{
