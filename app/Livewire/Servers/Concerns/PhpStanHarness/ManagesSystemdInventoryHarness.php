...
use App\Livewire\Servers\Concerns\ManagesSystemdInventory;

/** @internal PHPStan harness for ManagesSystemdInventory */
final class ManagesSystemdInventoryHarness extends Component
{
