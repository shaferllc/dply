...
use App\Livewire\Servers\Concerns\ManagesSystemdModals;

/** @internal PHPStan harness for ManagesSystemdModals */
final class ManagesSystemdModalsHarness extends Component
{
