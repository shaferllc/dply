...
use App\Livewire\Concerns\ManagesSiteBindingMail;
use App\Livewire\Concerns\WatchesConsoleActionOutcomes;

/** @internal PHPStan harness for ManagesSiteBindingMail */
final class ManagesSiteBindingMailHarness extends Component
{
