...
/** @internal PHPStan harness for StagesBackupDownloads */
final class StagesBackupDownloadsHarness extends Component
{
    use StagesBackupDownloads;
    public Server $server;
    protected function resolveDownloadableBackup(string $type, string $backupId): ?Model { return null; }
