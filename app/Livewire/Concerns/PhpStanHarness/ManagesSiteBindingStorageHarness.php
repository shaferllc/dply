...
use App\Livewire\Concerns\ManagesSiteBindingStorage;

/** @internal PHPStan harness for ManagesSiteBindingStorage */
final class ManagesSiteBindingStorageHarness extends Component
{
