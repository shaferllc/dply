...
/** @internal PHPStan harness for DismissesConsoleActionRun */
final class DismissesConsoleActionRunHarness extends Component
{
    use DismissesConsoleActionRun;
    protected function consoleActionSubject(): Model { return new Site(); }
