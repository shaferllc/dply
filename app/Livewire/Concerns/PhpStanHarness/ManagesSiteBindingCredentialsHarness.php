...
use App\Livewire\Concerns\ManagesSiteBindingCredentials;

/** @internal PHPStan harness for ManagesSiteBindingCredentials */
final class ManagesSiteBindingCredentialsHarness extends Component
{
