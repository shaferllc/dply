...
use App\Actions\AttributeValidator;
 ...
 * @method array<string, mixed> getValidationData(\Lorisleiva\Actions\ActionRequest $request)
 * @method array<string, mixed> getValidationMessages()
 * @method array<string, mixed> getValidationAttributes()
