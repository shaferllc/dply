...
/**
 * Set the desired instance count for an edge site.
 *
 *   dply:edge:scale <site> --instances=N
 *
 ...
 */
class EdgeScaleCommand extends Command
{
    protected $signature = 'dply:edge:scale
        {site : Site ID, slug, or name}
        {--instances= : Desired instance count (1-50)}
        {--no-redeploy : Persist the change only, do not queue a redeploy}';

    protected $description = 'Set the desired instance count for an edge container site.';
