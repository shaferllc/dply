 ...
 *
 * For image-mode rollouts of a NEW tag, use dply:edge:deploy
 * (which sets the image first). For env changes, dply:edge:env.
 */
class EdgeRedeployCommand extends Command
{
    protected $signature = 'dply:edge:redeploy
        {site : Site ID, slug, or name}';

    protected $description = 'Trigger a redeploy of an edge site without changing image or env vars.';
