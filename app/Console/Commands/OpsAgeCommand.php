 ...
 *
 *   dply:ops:age
 *   dply:ops:age --older-than=365     # at least N days old
 *   dply:ops:age --younger-than=30    # at most N days old
 *   dply:ops:age --json
 *
 ...
 */
class OpsAgeCommand extends Command
{
    protected $signature = 'dply:ops:age
    ...
    /** Renamed from dply:fleet:age when the Fleet concept was dropped; old name still works. */
    protected $aliases = ['dply:fleet:age'];
