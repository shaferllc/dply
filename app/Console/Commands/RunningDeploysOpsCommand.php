 ...
 *
 *   dply:ops:running-deploys
 *   dply:ops:running-deploys --json
 *   dply:ops:running-deploys --older-than=15
 *
 ...
 */
class RunningDeploysOpsCommand extends Command
{
    protected $signature = 'dply:ops:running-deploys
    ...
    /** Renamed from dply:fleet:running-deploys when the Fleet concept was dropped; old name still works. */
    protected $aliases = ['dply:fleet:running-deploys'];
