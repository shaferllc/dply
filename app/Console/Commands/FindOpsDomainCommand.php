 ...
 *
 *   dply:ops:domain-find example.com
 *   dply:ops:domain-find example.com --contains       # substring match
 *   dply:ops:domain-find .example.com --contains
 *   dply:ops:domain-find example.com --json
 *
 ...
 */
class FindOpsDomainCommand extends Command
{
    protected $signature = 'dply:ops:domain-find
    ...
    /** Renamed from dply:fleet:domain-find when the Fleet concept was dropped; old name still works. */
    protected $aliases = ['dply:fleet:domain-find'];
