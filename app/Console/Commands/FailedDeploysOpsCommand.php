 ...
 *
 *   dply:ops:failed-deploys
 *   dply:ops:failed-deploys --include-running
 *   dply:ops:failed-deploys --json
 *
 ...
 */
class FailedDeploysOpsCommand extends Command
{
    protected $signature = 'dply:ops:failed-deploys
    ...
    /** Renamed from dply:fleet:failed-deploys when the Fleet concept was dropped; old name still works. */
    protected $aliases = ['dply:fleet:failed-deploys'];
