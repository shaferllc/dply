...
/**
 * Push env vars to a deployed edge site from the CLI.
 *
 *   dply:edge:env <site> --file=.env.production
 *   dply:edge:env <site> --set=KEY=value
 *
 ...
 */
class EdgeEnvCommand extends Command
{
    protected $signature = 'dply:edge:env
