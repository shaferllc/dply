...
class SyncLogStoreSchemaCommand extends Command
{
    ...
    public function handle(ClickHouseClient $client): int
    {
        ...
        // search on message. TTL drops whole day-partitions past the retention
        // window (the free-MVP floor; per-tier retention comes with billing).
        $createTable = <<<SQL
        ...
        $this->info("Creating table {$table} (TTL {$retentionDays}d) …");
