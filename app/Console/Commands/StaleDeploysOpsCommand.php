 ...
 *
 *   dply:ops:stale-deploys                  # default 30 days
 *   dply:ops:stale-deploys --days=90
 *   dply:ops:stale-deploys --include-never  # also include never-deployed sites
 *   dply:ops:stale-deploys --json
 *
 * Useful for:
 ...
 * surface at the top.
 */
class StaleDeploysOpsCommand extends Command
{
    protected $signature = 'dply:ops:stale-deploys
    ...
    /** Renamed from dply:fleet:stale-deploys when the Fleet concept was dropped; old name still works. */
    protected $aliases = ['dply:fleet:stale-deploys'];
