...
/**
 * Attach a custom hostname to an edge container site.
 *
 *   dply:edge:domain:attach <site> <hostname>
 *
 * Queues AttachEdgeDomainJob, which talks to the backend's
 ...
 */
class EdgeDomainAttachCommand extends Command
{
    protected $signature = 'dply:edge:domain:attach
        {site : Site ID, slug, or name}
        {hostname : Fully-qualified hostname (e.g. api.example.com)}';

    protected $description = 'Attach a custom domain to an edge container site.';
    ...
    public function handle(): int
    {
        ...
        AttachEdgeDomainJob::dispatch($site->id, $hostname);
