 ...
 * STATUS_PENDING?
 */
class OpsSummaryCommand extends Command
{
    protected $signature = 'dply:ops:summary
        {--json : Output as JSON}';

    protected $description = 'Fleet stats — server count, site count by runtime, engines in use.';

    /** Renamed from dply:fleet:summary when the Fleet concept was dropped; old name still works. */
    protected $aliases = ['dply:fleet:summary'];
