 ...
 *
 *   dply:ops:domain-list                        # all domains
 *   dply:ops:domain-list --primary-only         # primaries only
 *   dply:ops:domain-list --runtime=node
 *   dply:ops:domain-list --json
 *
 ...
 */
class ListOpsDomainsCommand extends Command
{
    protected $signature = 'dply:ops:domain-list
    ...
    /** Renamed from dply:fleet:domain-list when the Fleet concept was dropped; old name still works. */
    protected $aliases = ['dply:fleet:domain-list'];
