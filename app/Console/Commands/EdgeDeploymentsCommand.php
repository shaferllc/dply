...
/**
 * List recent deployments for an edge container site.
 *
 *   dply:edge:deployments <site> [--limit=10] [--json]
 *
 * Backend behavior:
 ...
 *     the AWS console.
 *   - FakeEdgeBackend: returns synthetic entries so dev installs
 *     see something useful.
 */
class EdgeDeploymentsCommand extends Command
{
    protected $signature = 'dply:edge:deployments
        {site : Site ID, slug, or name}
        {--limit=10 : How many deployments to fetch (1-100)}
        {--json : Output as JSON}';

    protected $description = 'List recent deployments for an edge container site.';
