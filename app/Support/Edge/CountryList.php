...
/**
 * ISO 3166-1 alpha-2 country codes + display names. Used by the
 * Edge firewall country picker to power the autocomplete and to
 * render selected tags with friendly labels.
 */
final class CountryList
{
    /**
     * Code => English country name, sorted alphabetically by name.
     *
