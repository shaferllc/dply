    ...
    public static function all(): array
    {
        return [
            ...
            'openlitespeed' => [
                ...
                'best_for' => __('PHP workloads where the LiteSpeed cache module matters. Note: dply doesn\'t install `lsphpXX` packages yet (v1.1).'),
            ...
            'traefik' => [
                ...
                'description' => __('Reverse proxy and load balancer that auto-discovers backends from Docker, Kubernetes, Consul, etc. Not a traditional webserver — it proxies to upstream application servers, doesn\'t serve PHP/Ruby/static files directly. Native ACME support; YAML/TOML config; rich Prometheus metrics out of the box.'),
                'homepage_url' => 'https://traefik.io',
                'docs_url' => 'https://doc.traefik.io/traefik/',
                'license' => 'MIT',
                'maintainer' => 'Traefik Labs',
                'best_for' => __('Routing in front of containerized services (Node, Go, Python apps). Not a fit when sites need PHP-FPM or static-file serving directly.'),
