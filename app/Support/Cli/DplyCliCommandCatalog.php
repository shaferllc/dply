...
final class DplyCliCommandCatalog
{
    ...
    public static function entries(?string $serverId = null): array
    {
        ...
        $raw = [
            ...
            ['id' => 'site-artisan', 'group' => 'site', 'title' => 'site artisan', 'command' => 'dply site artisan <site> -- migrate --force', 'summary' => 'php artisan on the site — risk-gated, audited, queued for long commands.', 'scope' => 'commands.run', 'keywords' => 'laravel migrate tinker console command'],
