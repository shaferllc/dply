...
final class DplyCliCommandCatalog
{
    ...
    public static function entries(?string $serverId = null): array
    {
        ...
        $raw = [
            ...
            ['id' => 'sites-all', 'group' => 'site', 'title' => 'sites', 'command' => 'dply sites', 'summary' => 'Every site — VM, Cloud, Edge, serverless — with its kind.', 'scope' => 'sites.read', 'keywords' => 'list apps functions everything'],
            ['id' => 'sites-kind', 'group' => 'site', 'title' => 'sites --kind', 'command' => 'dply sites --kind cloud', 'summary' => 'One product: vm | cloud | edge | serverless.', 'scope' => 'sites.read', 'keywords' => 'filter product kind'],
            ...
            ['id' => 'serverless-platform', 'group' => 'serverless', 'title' => 'serverless platform', 'command' => 'dply serverless platform --site <site>', 'summary' => 'Deployed action, limits, and namespace inventory.', 'scope' => 'serverless.read', 'keywords' => 'inspector action runtime limits namespace'],
            ['id' => 'serverless-platform-schedules', 'group' => 'serverless', 'title' => 'serverless platform --schedules', 'command' => 'dply serverless platform --site <site> --schedules', 'summary' => 'Cron triggers on the function.', 'scope' => 'serverless.read', 'keywords' => 'cron schedule trigger'],
            ['id' => 'serverless-invoke', 'group' => 'serverless', 'title' => 'serverless invoke', 'command' => 'dply serverless invoke --site <site> --method POST --path /health', 'summary' => 'Send a test request; recorded as a test invocation.', 'scope' => 'serverless.invoke', 'keywords' => 'console test request curl'],
            ['id' => 'serverless-credentials', 'group' => 'serverless', 'title' => 'serverless credentials', 'command' => 'dply serverless credentials --site <site>', 'summary' => 'Namespace key dply holds (--set to rotate).', 'scope' => 'serverless.read', 'keywords' => 'key namespace access rotate'],
            ['id' => 'serverless-workers', 'group' => 'serverless', 'title' => 'serverless workers', 'command' => 'dply serverless workers --site <site>', 'summary' => 'Queue engine + worker definitions (--enable · --tick · --add).', 'scope' => 'serverless.read', 'keywords' => 'queue worker background daemon tick'],
            ['id' => 'serverless-schedule', 'group' => 'serverless', 'title' => 'serverless schedule', 'command' => 'dply serverless schedule --site <site>', 'summary' => 'Scheduler switch + firing history (--enable · --tick · --failed).', 'scope' => 'serverless.read', 'keywords' => 'scheduler cron tick background history'],
            ['id' => 'serverless-env', 'group' => 'serverless', 'title' => 'serverless env', 'command' => 'dply serverless env --site <site> list', 'summary' => 'Environment variables (list · set · rm · push · pull).', 'scope' => 'serverless.read', 'keywords' => 'environment variables dotenv secrets'],
            ['id' => 'serverless-runtime', 'group' => 'serverless', 'title' => 'serverless runtime', 'command' => 'dply serverless runtime --site <site>', 'summary' => 'Limits, HTTP exposure, parameters, maintenance, warm start.', 'scope' => 'serverless.read', 'keywords' => 'memory timeout concurrency cors maintenance warm'],
