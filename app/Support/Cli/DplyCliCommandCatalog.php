...
final class DplyCliCommandCatalog
{
    ...
    public static function entries(?string $serverId = null): array
    {
        ...
        $raw = [
            ...
            ['id' => 'site-artisan', 'group' => 'site', 'title' => 'site artisan', 'command' => 'dply site artisan --site <site> -- migrate --force', 'summary' => 'php artisan on the site — risk-gated, audited, queued for long commands.', 'scope' => 'commands.run', 'keywords' => 'laravel migrate tinker console command'],
            ['id' => 'site-artisan-run', 'group' => 'site', 'title' => 'site artisan --run', 'command' => 'dply site artisan --site <site> --run <run-id>', 'summary' => 'Read back a queued artisan run (pairs with --no-wait).', 'scope' => 'commands.run', 'keywords' => 'poll status run'],
