...
class CaddyWebserverConfigEngine implements WebserverConfigEngineInterface
{
    public function __construct(
        private readonly CaddySiteConfigBuilder $builder,
        private readonly SiteCaddyProvisioner $provisioner,
    ) {}
    ...
    public function validateLocal(string $config): array
    {
        return [
            'ok' => true,
            'message' => __('Local Caddy validation runs on the server. Use “Validate on server”.'),
        ];
    }
