...
/**
 * Validates a parsed {@see RepoConfig} snapshot. Used by the build
 * runner (fail deploy on fatal parse errors), the public lint API, and
 * `dply edge lint`.
 */
class RepoConfigLinter
{
    public function __construct(
        private readonly RepoConfigLoader $loader,
    ) {}
     ...
     * @return array<string, mixed>
     */
    public function lint(?RepoConfig $config): array
    {
        if ($config === null) {
