...
final class SigV4Verifier
{
    ...
    /**
     * @return array{ok: bool, access_key_id: ?string, error: ?string}
     */
    public function parse(Request $request): array
    {
        ...
        if (! str_starts_with($header, 'AWS4-HMAC-SHA256')) {
            return ['ok' => false, 'access_key_id' => null, 'error' => 'Missing or unsupported Authorization header.'];
        }
        ...
        if ($credential === null
            ...
            return ['ok' => false, 'access_key_id' => null, 'error' => 'Malformed Authorization header.'];
        }
        ...
        if (count($segments) < 5) {
            return ['ok' => false, 'access_key_id' => null, 'error' => 'Malformed credential scope.'];
        }

        return ['ok' => true, 'access_key_id' => $segments[0], 'error' => null];
    }
