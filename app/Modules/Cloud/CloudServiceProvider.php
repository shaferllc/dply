    ...
    public function register(): void
    {
        if ($this->app->runningInConsole()) {
            $this->commands([
                ...
                Console\CloudDatabaseBackupsCommand::class,
                Console\CloudDatabaseCreateCommand::class,
                Console\CloudDatabaseDetachCommand::class,
                Console\CloudDatabaseListCommand::class,
                Console\CloudDatabaseMetricsCommand::class,
                Console\CloudDatabaseRestoreCommand::class,
                Console\CloudDatabaseScaleCommand::class,
                Console\CloudDatabaseTeardownCommand::class,
                Console\CloudDatabaseUsersCommand::class,
