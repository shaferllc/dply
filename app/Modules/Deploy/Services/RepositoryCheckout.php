...
/**
 * Clone a repository into a temporary workspace for inspection.
 *
 * Nothing here is serverless-specific — it is a git checkout — but it was named
 * ServerlessRepositoryCheckout and so was deleted with that surface
 * (remove-cloud-edge-serverless), taking LocalRepositoryInspector and the site
 * create wizard's runtime detection down with it. Restored under a neutral
 * name; the body is unchanged.
 */
final class RepositoryCheckout
{
