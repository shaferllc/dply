...
/**
 * Pick the network this app's database and cache live in.
 *
 * The sibling of {@see DatabasePanel} / {@see CachePanel}, and deliberately
 * rendered above them: a network houses those resources, so the choice comes
 * before provisioning them. See {@see ServerlessNetworkService} for what a
 * network does and does not buy you here.
 */
class NetworkPanel extends Component
{
    ...
    public function attach(): void
    {
        ...
        $this->toastSuccess(__('Attached. New databases and caches will be created inside this network.'));
    }
