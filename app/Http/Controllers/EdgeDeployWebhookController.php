...
/**
 * Inbound deploy webhook for edge container sites — used by CI
 ...
 * that gets passed through to RedeployEdgeSiteJob, so a CI run
 ...
 */
class EdgeDeployWebhookController extends Controller
{
    public function __invoke(Request $request, Site $site): JsonResponse
    {
        ...
        RedeployEdgeSiteJob::dispatch($site->id, $newImage);
