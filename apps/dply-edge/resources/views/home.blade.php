...
@section('title', config('app.name').' – JavaScript, git, and edge delivery')

@section('meta_description', 'dply Edge: git-native builds for Next, Nuxt, Astro, and static sites—preview workflows and a Bearer-token API aligned with the dply platform.')
...
@section('content')
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-14 lg:items-center">
                <div class="lg:col-span-6 text-center lg:text-left">
                    ...
                    <p class="mt-6 text-lg sm:text-xl text-brand-moss max-w-xl mx-auto lg:mx-0 leading-relaxed">
                        Framework-native deploys for serious teams—projects, deployments, and automation APIs without bolting on a generic static host.
                    </p>
                    ...
                    <p class="mt-6 text-sm text-brand-moss lg:text-left text-center max-w-xl mx-auto lg:mx-0">
                        ...
                        Sign in on the main app; Edge uses your org context and token patterns.
                    </p>
                </div>
                        ...
                        <div class="relative rounded-3xl border border-brand-ink/10 bg-white/85 backdrop-blur-md p-8 sm:p-10 shadow-xl shadow-brand-forest/10 ring-1 ring-brand-ink/5">
                            ...
                            <ul class="mt-4 space-y-3 text-sm text-brand-moss">
                                <li class="flex gap-3">
                                    ...
                                    <span><strong class="text-brand-ink">Projects</strong> with framework hints, git refs, and deployment history.</span>
                                </li>
                                <li class="flex gap-3">
                                    <span class="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-brand-gold"></span>
                                    <span><strong class="text-brand-ink">Bearer API</strong> — set <code class="text-xs bg-brand-ink/5 px-1 rounded">EDGE_API_TOKEN</code> for CI.</span>
                                </li>
                                <li class="flex gap-3">
                                    <span class="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-brand-gold"></span>
                                    <span><strong class="text-brand-ink">Idempotent deploys</strong> when you need replay-safe pipelines.</span>
                                </li>
                            </ul>
    ...
    <section class="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 border-t border-brand-ink/8 bg-white/50">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-center text-2xl sm:text-3xl font-bold text-brand-ink tracking-tight">Built for modern JS stacks</h2>
            <p class="mt-4 text-center text-brand-moss max-w-2xl mx-auto text-lg">
                Edge is the Vercel-class lane in the dply family—git, builds, and delivery—not a catch-all for Rails monoliths.
            </p>
            <div class="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="rounded-2xl border border-brand-ink/10 bg-brand-cream/80 p-8 shadow-sm shadow-brand-forest/5">
                    <h3 class="text-lg font-semibold text-brand-ink">Repo-native workflows</h3>
                    <p class="mt-2 text-sm text-brand-moss leading-relaxed">Branch and preview semantics match how your team already ships—wired into the same dply org model.</p>
                </div>
                <div class="rounded-2xl border border-brand-ink/10 bg-brand-cream/80 p-8 shadow-sm shadow-brand-forest/5">
                    <h3 class="text-lg font-semibold text-brand-ink">Automation-friendly</h3>
                    <p class="mt-2 text-sm text-brand-moss leading-relaxed">Queue-backed deploy records and structured output for operators and internal tooling.</p>
                </div>
                <div class="rounded-2xl border border-brand-ink/10 bg-brand-cream/80 p-8 shadow-sm shadow-brand-forest/5 sm:col-span-2 lg:col-span-1">
                    <h3 class="text-lg font-semibold text-brand-ink">Platform fit</h3>
                    <p class="mt-2 text-sm text-brand-moss leading-relaxed">Complements BYO and Serverless—use the right product line per workload without duplicating accounts.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center rounded-3xl border border-brand-ink/10 bg-gradient-to-br from-brand-forest/90 to-brand-ink text-brand-cream px-8 py-14 sm:px-12 shadow-xl shadow-brand-forest/20">
            <h2 class="text-2xl sm:text-3xl font-bold tracking-tight">Connect Edge to your dply org</h2>
            <p class="mt-4 text-brand-sand/90 text-lg max-w-xl mx-auto">
                Start with the main dply app, then wire Edge projects through the control-plane API when your rollout includes this product line.
            </p>
