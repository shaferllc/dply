        ...
        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
            <div class="max-w-sm">
                ...
                <p class="mt-4 text-sm leading-relaxed text-brand-mist">
                    Git-native JavaScript frameworks and static sites—previews, CDN-style delivery, and an API-first control plane aligned with the rest of dply.
                </p>
            </div>
            <div class="flex flex-wrap gap-12 sm:gap-16 text-sm">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wider text-brand-gold/90 mb-3">dply Edge</p>
                    <ul class="space-y-2.5 text-brand-sand/80">
                        ...
                        <li><span class="text-brand-mist">API</span> <code class="text-xs text-brand-sand/60">/api/edge/*</code></li>
                    </ul>
                </div>
                <div>
