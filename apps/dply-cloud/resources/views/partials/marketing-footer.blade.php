        ...
        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
            <div class="max-w-sm">
                ...
                <p class="mt-4 text-sm leading-relaxed text-brand-mist">
                    Long-running PHP and Rails on dply-managed capacity—traditional processes and routing, with the same org and API discipline as BYO.
                </p>
            </div>
            <div class="flex flex-wrap gap-12 sm:gap-16 text-sm">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wider text-brand-gold/90 mb-3">dply Cloud</p>
                    <ul class="space-y-2.5 text-brand-sand/80">
                        ...
                        <li><span class="text-brand-mist">API</span> <code class="text-xs text-brand-sand/60">/api/cloud/*</code></li>
                    </ul>
                </div>
                <div>
