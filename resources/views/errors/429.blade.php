...
@section('content')
    ...
    <p class="text-base text-brand-moss mb-8 max-w-md mx-auto leading-relaxed">
        {{ __('You have made too many requests in a short period. Please wait a moment before trying again. This helps us keep the service running smoothly for everyone.') }}
    </p>
@endsection

@section('smart-actions')
    <div class="mt-8 pt-8 border-t border-brand-ink/10">
        <p class="text-sm font-medium text-brand-ink mb-4">{{ __('Please wait a moment') }}</p>
