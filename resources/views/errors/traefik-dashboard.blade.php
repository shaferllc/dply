...
@section('smart-actions')
    <div class="mt-8 pt-8 border-t border-brand-ink/10">
        ...
        <div class="flex flex-wrap items-center justify-center gap-3">
            @if (isset($server))
                <a
                    href="{{ route('servers.edge-proxy', $server).'?tab=traefik' }}"
