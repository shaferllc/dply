        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <ul class="space-y-4 mb-10">
                @foreach ([
                    ...
                    ['slug' => 'edge-build', 'title' => 'Edge build settings', 'desc' => 'Build command, webhooks, hybrid origin, and image optimization.'],
                    ['slug' => 'edge-previews', 'title' => 'Edge previews', 'desc' => 'PR and branch preview deployments.'],
