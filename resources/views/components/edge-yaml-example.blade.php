...
<div {{ $attributes->class(['space-y-1.5']) }} x-data="{ copied: false }">
    <div class="flex flex-wrap items-center justify-between gap-2">
        ...
        <button
            type="button"
            class="inline-flex items-center gap-1 rounded-lg border border-brand-ink/10 bg-white px-2 py-1 text-[11px] font-medium text-brand-moss hover:bg-brand-sand/40 dark:border-brand-mist/20 dark:bg-zinc-900"
    ...
    @endif
    <pre class="overflow-x-auto rounded-lg bg-brand-ink/95 px-3 py-2.5 font-mono text-[11px] leading-relaxed text-brand-sand"><code>{{ $code }}</code></pre>
</div>
