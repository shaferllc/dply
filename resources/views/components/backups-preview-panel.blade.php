...
>
    ...
    <div @class([
        ...
        <div class="relative flex items-start justify-between gap-3">
            ...
            <span class="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-2xs font-semibold uppercase tracking-[0.16em] text-indigo-200/90">
