@props([
    ...
    /**
     * Opt-in dense chrome: swaps the icon-badge + title + prose stack for the
     * one-line x-workspace-panel-head used across the server workspace, and
     * lets the `stats` slot span the card as its own strip instead of sitting
     * inside the sand header. Callers that don't pass it are unchanged.
     */
    'dense' => false,
])
