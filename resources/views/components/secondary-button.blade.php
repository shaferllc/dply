...
@php
    $classes = match($size) {
        ...
        'xs' => 'inline-flex items-center justify-center whitespace-nowrap gap-1.5 rounded-lg border border-brand-ink/15 bg-white px-2.5 py-1 text-xs font-semibold uppercase tracking-wide text-brand-ink shadow-sm hover:bg-brand-sand/50 transition-colors disabled:cursor-not-allowed disabled:opacity-50',
