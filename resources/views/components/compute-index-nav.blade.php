...
{{--
    The Compute row: the machines your code runs on. The only workspace nav
    row — the Services row that used to sit beneath it was removed; those
    entries live in the header's Compute dropdown.
--}}
