...
@if ($label)
    <span {{ $attributes->merge(['class' => 'inline-flex shrink-0 items-center rounded px-1.5 py-0.5 text-3xs font-semibold uppercase tracking-wide ring-1 ring-inset '.match ($role) {
