@props([
     ...
     * treated as the Infrastructure landing page (no deeper crumb).
     */
    'section' => null,
...
@php
    ...
    if ($section !== null) {
        $crumbs[] = ['label' => __('Infrastructure'), 'href' => route('infrastructure.index'), 'icon' => 'rectangle-group'];
        $crumbs[] = ['label' => $section];
    } else {
        $crumbs[] = ['label' => __('Infrastructure'), 'icon' => 'rectangle-group'];
    }
@endphp
    ...
    <div class="dply-page-shell {{ $width }} py-8 sm:py-10">
        ...
        <section class="dply-card min-w-0 overflow-hidden p-0">
            ...
            <div class="border-b border-brand-ink/10 px-3 py-2 sm:px-4">
                @include('livewire.infrastructure._tabs')
            </div>
