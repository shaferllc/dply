...
<div @if ($state === 'provisioning') wire:poll.10s @endif class="border-t border-brand-ink/10">
    <x-workspace-panel-head
        dense
        icon="heroicon-o-circle-stack"
        :title="__('Database')"
        :note="__('A DigitalOcean Managed Database, with the connection wired into this function\'s environment.')"
    >
        @if ($state !== '')
            <x-slot:actions>
                <span @class([
