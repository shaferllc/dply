...
<div>
    ...
    >
        ...
        @if ($setup_source === 'servers.create')
            ...
            <div class="border-b border-brand-ink/10 bg-amber-50/60 px-5 py-5 sm:px-6">
        ...
        @else
            <ul class="divide-y divide-brand-ink/10">
                @foreach ($sshKeys as $key)
                    <li wire:key="ssh-key-{{ $key->id }}" class="flex items-center justify-between gap-4 px-5 py-3.5 transition-colors hover:bg-brand-sand/15 sm:px-6">
