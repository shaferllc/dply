    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <x-organization-shell :organization="$organization" section="realtime" :breadcrumb="$breadcrumbs">
            ...
            <div class="mt-6 grid gap-6 lg:grid-cols-3">
                {{-- Live stats --}}
                <section class="dply-card p-5 sm:p-6">
                    ...
                    <p class="mt-3 text-2xl font-semibold text-brand-ink">
                        {{ number_format((int) ($app->peak_connections ?? 0)) }}
                        <span class="text-sm font-normal text-brand-moss">/ {{ number_format($tier['max_connections']) }} {{ __('peak') }}</span>
                    </p>
                ...
                {{-- Credentials --}}
                @if ($canManage)
                    <section class="dply-card p-5 sm:p-6 lg:col-span-2">
