...
<div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
            ...
            <x-slot:stats>
                <dl class="grid grid-cols-3 gap-3" aria-label="{{ __('Teams at a glance') }}">
            ...
            <section class="border-b border-brand-ink/10 last:border-b-0">
                ...
                <div class="p-5 sm:p-6">
                    @if ($organization->teams->isEmpty())
                        <div class="rounded-xl border border-dashed border-brand-ink/15 bg-brand-cream/30 px-6 py-12 text-center">
                        ...
                        <ul class="space-y-4">
                            @foreach ($organization->teams as $team)
                                @php
                                    ...
                                    $isAdmin = $organization->hasAdminAccess(auth()->user());
                                @endphp
                                <li class="overflow-hidden rounded-xl border border-brand-ink/10 bg-brand-cream/30 dark:border-brand-mist/20 dark:bg-zinc-900/80">
