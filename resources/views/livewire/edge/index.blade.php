<div class="mx-auto max-w-6xl px-6 py-10">
    <header class="mb-6 flex flex-wrap items-end justify-between gap-4 border-b border-slate-200 pb-4">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-600">{{ __('Container apps deployed on the dply edge platform across :org.', ['org' => $org->name]) }}</p>
        </div>
    ...
    @if ($sites->isEmpty())
        <div class="rounded-2xl border border-slate-200 bg-white p-8 text-center text-sm text-slate-600 shadow-sm">
            ...
            <p class="mt-1">{{ __('Container apps you deploy via the dply edge will appear here.') }}</p>
        </div>
    @else
