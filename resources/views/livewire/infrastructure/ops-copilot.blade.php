<div>
    <x-infrastructure-shell
        ...
        :description="__('Cross-engine deploy triage for AI-built repos — reads the latest failure log, repo config, and intelligence alerts, then suggests concrete fixes. Heuristic v1; optional LLM synthesis when configured.')"
        :section="__('Copilot')"
        ...
        <div class="grid lg:grid-cols-[minmax(0,280px)_1fr] lg:divide-x lg:divide-brand-ink/10">
            ...
            <section class="min-w-0 divide-y divide-brand-ink/10">
                @if ($siteId === '' || $selectedSite === null)
                    <x-infrastructure-empty :title="__('Pick a site with a failed deploy')">
