...
<section class="dply-card overflow-hidden">
    <div class="border-b border-brand-ink/10 px-6 py-4 sm:px-8">
        ...
        <p class="mt-0.5 text-sm text-brand-moss">{{ __('Pull request previews deploy automatically from the GitHub webhook. Create a one-off preview from any branch tip or commit below — each commit gets its own Edge URL.') }}</p>
    </div>
