...
@else
    <div class="space-y-6">
        ...
        @else
            <section class="dply-card overflow-hidden">
                <div class="border-b border-brand-ink/10 px-6 py-4 sm:px-8">
                    <h3 class="text-base font-semibold text-brand-ink">{{ __('Platform pricing') }}</h3>
                    <p class="mt-0.5 text-sm text-brand-moss">{{ __('Flat fee per live Edge site on your organization plan.') }}</p>
                </div>
