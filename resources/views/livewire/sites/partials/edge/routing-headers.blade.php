<section class="px-5 py-4 sm:px-6">
    <div>
        <p class="text-[10px] font-semibold uppercase tracking-[0.16em] text-brand-mist">{{ __('Headers') }}</p>
    ...
    <form wire:submit.prevent="addHeaderRule" class="mt-4 space-y-2">
        <div>
            <label for="new-header-for" class="text-[10px] font-semibold uppercase tracking-wide text-brand-mist">{{ __('Path pattern') }}</label>
