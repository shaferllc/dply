...
<section class="dply-card" x-data="{
    tab: 'read',
    ...
    <div class="border-b border-brand-ink/10 px-6 py-4 sm:px-8">
        <h3 class="text-base font-semibold text-brand-ink">{{ __('Edge runtime') }}</h3>
        <p class="mt-0.5 text-sm text-brand-moss">{{ __('What your worker can read from `env`. dply provisions a default KV namespace per site automatically; declare more in wrangler.toml or dply.yaml.') }}</p>
    </div>
