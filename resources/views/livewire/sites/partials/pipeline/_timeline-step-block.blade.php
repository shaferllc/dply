...
<div
    ...
    class="inline-flex max-w-full cursor-grab items-center gap-2 active:cursor-grabbing"
>
    ...
    @foreach ($block['hooks'] as $hook)
        @include('livewire.sites.partials.pipeline._timeline-hook-pill', ['hook' => $hook])
    @endforeach
