                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    ...
                    <section class="dply-card overflow-hidden">
                        ...
                        <ul class="divide-y divide-brand-ink/8 px-6 sm:px-8">
                            <li class="flex items-start justify-between gap-3 py-3">
                                ...
                                <span class="shrink-0 rounded-full px-2 py-0.5 text-2xs font-semibold uppercase tracking-wide
                            ...
                            <li class="flex items-start justify-between gap-3 py-3">
                                <div class="min-w-0">
                                    ...
                                    <p class="break-all font-mono text-xs text-brand-mist">{{ \Illuminate\Support\Str::limit((string) ($foundationStatus['current_runtime_revision'] ?? '—'), 24) }}</p>
                                </div>
                                <span class="shrink-0 rounded-full px-2 py-0.5 text-2xs font-semibold uppercase tracking-wide
                            ...
                            <li class="flex items-start justify-between gap-3 py-3"
                                ...
                                <div class="min-w-0">
                                    ...
                                    <button type="button" wire:click="recheckSsl" wire:loading.attr="disabled" wire:target="recheckSsl"
                                        ...
                                        class="mt-1 text-xs font-semibold text-brand-forest hover:underline disabled:opacity-50">
                            ...
                            @if ($site->isSuspended())
                                <li class="flex items-start justify-between gap-3 py-3">
                                    ...
                                    <span class="shrink-0 rounded-full bg-amber-100 px-2 py-0.5 text-2xs font-semibold uppercase tracking-wide text-amber-900">{{ __('Suspended') }}</span>
                                </li>
                            @endif
                                    ...
                                    <ul class="mt-2 space-y-1.5">
                                        @foreach ($hostChecks as $check)
                                            <li class="flex items-center justify-between gap-3 rounded-lg border {{ ($check['ok'] ?? false) ? 'border-emerald-200 bg-emerald-50/60' : 'border-amber-200 bg-amber-50/60' }} px-3 py-2">
                                                <p class="break-all font-mono text-xs text-brand-ink">{{ $check['hostname'] }}</p>
                    ...
                    <section class="dply-card overflow-hidden">
                        <div class="flex items-start gap-3 border-b border-brand-ink/10 bg-brand-sand/20 px-6 py-5 sm:px-7">
                            ...
                            <div class="min-w-0">
                                <p class="text-xs font-semibold uppercase tracking-[0.16em] text-brand-sage">{{ __('Preflight') }}</p>
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    ...
                    <section class="dply-card overflow-hidden">
                        <div class="flex items-start gap-3 border-b border-brand-ink/10 bg-brand-sand/20 px-6 py-5 sm:px-7">
                            ...
                            <div class="min-w-0">
                                <p class="text-xs font-semibold uppercase tracking-[0.16em] text-brand-sage">{{ __('Resources') }}</p>
