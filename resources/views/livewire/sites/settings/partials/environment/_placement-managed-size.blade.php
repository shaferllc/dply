...
<div>
    ...
    @if ($managedSizes === [])
        <p class="mt-1.5 text-xs font-medium text-amber-700">{{ __('Could not load managed-database plans from the provider. Reconnect the credential, or pick a different placement.') }}</p>
    @else
