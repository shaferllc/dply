...
<div class="border-t border-brand-ink/10 bg-brand-sand/25 px-3 py-2.5 sm:px-4">
    <x-cli-snippet :commands="[
        ['label' => __('Set Ruby version'), 'command' => 'dply dply:site:set-runtime '.$site->slug.' --runtime=ruby --runtime-version=3.3'],
        ['label' => __('Set start command'), 'command' => 'dply dply:site:set-runtime '.$site->slug.' --start=\'bundle exec puma -C config/puma.rb\' --port=3000'],
    ]" />
</div>
