    ...
    <div class="flex flex-col gap-4 bg-brand-sand/20 px-6 py-5 sm:flex-row sm:items-start sm:justify-between sm:gap-6 sm:px-7">
        <div class="flex min-w-0 items-start gap-3">
            ...
            <div class="min-w-0">
                ...
                <h2 class="mt-0.5 text-base font-semibold text-brand-ink">{{ __('DNS provider & zone') }}</h2>
                <p class="mt-1 text-sm leading-relaxed text-brand-moss">{{ __('Pick which connected DNS credential Dply uses for preview hostnames, DNS-01 challenges, and provisioning records. Leave the zone empty to fall back to the app testing-domain pool.') }}</p>
