            ...
            <div class="relative flex flex-wrap items-center gap-x-2 gap-y-2 min-w-0">
                ...
                <div class="relative min-w-0">
                    ...
                    <div
                        ...
                        class="absolute left-0 z-50 mt-2 w-[min(100vw-2rem,20rem)] rounded-2xl border border-brand-ink/10 bg-white py-2 shadow-xl shadow-brand-ink/10"
                        role="listbox"
                    >
                    ...
                    <div class="relative min-w-0">
                        ...
                        @else
                            ...
                            <div
                                ...
                                class="absolute left-0 z-50 mt-2 w-[min(100vw-2rem,20rem)] rounded-2xl border border-brand-ink/10 bg-white py-2 shadow-xl shadow-brand-ink/10 sm:left-auto sm:right-0"
                                role="listbox"
                            >
