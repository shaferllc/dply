{{--
    Lazy-load skeleton for Load balancers. Mirrors the merged page (hide-hero +
    single card with identity and list stubs).
--}}
    ...
    <section class="dply-card min-w-0 overflow-hidden p-0" aria-busy="true" aria-live="polite">
        ...
        <div class="border-b border-brand-ink/10" aria-hidden="true">
            <div class="flex items-start justify-between gap-3 border-b border-brand-ink/10 bg-brand-sand/20 px-5 py-5 sm:px-6">
                ...
                <span class="h-9 w-40 animate-pulse rounded-lg bg-brand-ink/10"></span>
            </div>
            <div class="space-y-3 px-5 py-8 sm:px-6">
                <div class="mx-auto h-24 w-full max-w-md animate-pulse rounded-xl bg-brand-ink/10"></div>
            </div>
        </div>
    </section>
</x-server-workspace-layout>
