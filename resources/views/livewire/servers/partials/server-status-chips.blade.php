...
--}}
{{--
    One calm meta line: the status badge is the single accent; everything else
    is muted inline text separated by middots. The site count is intentionally
    omitted here — it lives in the resource-tabs strip just below the row, so
    repeating it would be redundant noise.
--}}
