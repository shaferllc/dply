...
{{-- Nested inside the merged Errors card — same chrome as Stream / Deploys Notifications. --}}
<div>
        ...
        <div class="flex min-w-0 items-start gap-3">
            ...
            <div class="min-w-0">
                ...
                <p class="mt-1 max-w-2xl text-sm leading-relaxed text-brand-moss">
                    {{ __('Route a channel (email, Slack, Discord, webhook…) to this server’s error stream — get pinged when a deploy or operation fails.') }}
                </p>
            </div>
        </div>
        <a
    ...
    <p class="border-b border-brand-ink/10 px-5 py-3 text-xs leading-relaxed text-brand-moss sm:px-6">
        {{ __('Alerts fire once per captured failure as it lands in the stream. “Deployment failed” covers site deploys; “Server operation failed” covers everything else.') }}
    </p>
