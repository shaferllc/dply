...
<div>
    <div class="flex min-w-0 items-start gap-3 border-b border-brand-ink/10 px-5 py-5 sm:px-6">
        ...
        <div class="min-w-0 flex-1">
            ...
            <h3 class="mt-0.5 text-base font-semibold text-brand-ink">{{ __('Diagnostics & repair') }}</h3>
    ...
    <div class="px-5 py-5 sm:px-6">
        @if ($isDeployer)
            <div class="rounded-xl border border-amber-200/80 bg-amber-50/80 p-4 text-sm text-amber-950">
