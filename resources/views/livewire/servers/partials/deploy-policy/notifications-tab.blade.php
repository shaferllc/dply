...
{{-- Nested inside the merged Deploys card — dense heads, same as the Health and
     Security digest notification tabs. The icon-badge + eyebrow + title + prose
     stack and the standalone explainer below it cost ~160px before the first
     channel row; the explainer is a clause in the head note now. --}}
<div>
    ...
    <x-workspace-panel-head
        ...
        :note="__('Pick a channel, then the deploy-window events it should receive.')"
        class="border-b border-brand-ink/10"
    />

    <div class="px-4 py-3.5 sm:px-5">
        <form wire:submit="addDeployPolicyNotificationSubscription" class="space-y-3">
