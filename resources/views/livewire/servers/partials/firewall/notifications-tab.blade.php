...
<div class="min-w-0">
    {{-- Dense head, matching the rest of the workspace. Was a 10x10 icon badge, a
         text-lg title and wrapping prose in a py-5 band; the subscription count
         rides the count pill. --}}
