...
<div class="min-w-0">
    ...
    <x-workspace-panel-head
        ...
        :title="__('Backup alerts')"
        :note="__('Route a notification channel (email, Slack, Discord, webhook…) to this server\'s backup events — runs, completions, failures, and schedule changes. Each row binds one channel to one event.')"
