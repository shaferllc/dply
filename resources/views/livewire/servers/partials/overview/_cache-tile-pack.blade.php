    ...
    <section class="dply-card overflow-hidden">
        ...
        <div class="grid gap-3 p-6 sm:grid-cols-2 sm:p-7 lg:grid-cols-3">
            ...
            <a href="{{ $cachesUrl }}" wire:navigate class="group block rounded-2xl border border-brand-ink/10 bg-white px-4 py-3 shadow-sm transition hover:border-brand-sage/30 hover:shadow-md">
                ...
                <p class="mt-0.5 truncate text-xs text-brand-moss">{{ $memoryMeta }}</p>
                @if ($usedPct !== null)
            ...
            {{-- Total keys --}}
            <a href="{{ $cachesUrl }}" wire:navigate class="group block rounded-2xl border border-brand-ink/10 bg-white px-4 py-3 shadow-sm transition hover:border-brand-sage/30 hover:shadow-md">
                <p class="text-2xs font-semibold uppercase tracking-wide text-brand-mist">{{ __('Keys') }}</p>
                ...
                <p class="mt-0.5 truncate text-xs text-brand-moss">{{ __('Across all databases') }}</p>
            </a>

            {{-- Persistence (RDB / AOF) --}}
            <a href="{{ $cachesUrl }}" wire:navigate class="group block rounded-2xl border border-brand-ink/10 bg-white px-4 py-3 shadow-sm transition hover:border-brand-sage/30 hover:shadow-md">
                <p class="text-2xs font-semibold uppercase tracking-wide text-brand-mist">{{ __('Persistence') }}</p>
                <p class="mt-1 truncate text-base font-semibold text-brand-ink">{{ $persistenceHeadline }}</p>
                <p class="mt-0.5 truncate text-xs text-brand-moss">{{ $persistenceMeta }}</p>
            </a>

            {{-- Connected clients + ops/sec --}}
            <a href="{{ $cachesUrl }}" wire:navigate class="group block rounded-2xl border border-brand-ink/10 bg-white px-4 py-3 shadow-sm transition hover:border-brand-sage/30 hover:shadow-md">
                <p class="text-2xs font-semibold uppercase tracking-wide text-brand-mist">{{ __('Clients') }}</p>
            ...
            @endphp
            <a href="{{ $cachesUrl }}" wire:navigate class="group block rounded-2xl border border-brand-ink/10 bg-white px-4 py-3 shadow-sm transition hover:border-brand-sage/30 hover:shadow-md">
                <p class="text-2xs font-semibold uppercase tracking-wide text-brand-mist">{{ __('Role') }}</p>
                <p class="mt-1 truncate text-base font-semibold text-brand-ink">{{ $roleHeadline }}</p>
                <p class="mt-0.5 truncate text-xs text-brand-moss">{{ $roleMeta }}</p>
            </a>
        </div>
    </section>
@endif
