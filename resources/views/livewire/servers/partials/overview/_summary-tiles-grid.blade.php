{{-- 5 click-through stat tiles. Rendered inside the identity-hero card footer
     (and historically the standalone Workspace-summary section). Relies on the
     parent-scope vars: $healthValue / $healthMeta, $siteCount / $deployingCount,
     $databaseSummary, $installedStack, $latestDeployment, $backgroundSummary,
     $isWorkerRoleHost. --}}
@php
