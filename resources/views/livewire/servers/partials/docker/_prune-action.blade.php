...
<button
    ...
    class="inline-flex h-6 shrink-0 items-center gap-1 whitespace-nowrap rounded-md border border-amber-200 bg-amber-50 px-2 text-xs font-semibold text-amber-900 shadow-sm transition hover:bg-amber-100"
>
