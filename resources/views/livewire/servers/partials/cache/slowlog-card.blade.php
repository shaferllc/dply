...
>
    ...
    @elseif ($entries === [])
        <div class="mt-4 rounded-lg border border-emerald-200 bg-emerald-50/70 px-3 py-3 text-xs text-emerald-900">
            <p class="font-semibold">{{ __('Slowlog is empty.') }}</p>
            <p class="mt-1">{{ __('No commands have crossed the slowlog threshold since the engine started or the log was last reset.') }}</p>
        </div>
    @else
