            ...
            <x-slot:tabs>
                <x-server-workspace-tablist :aria-label="__('Networking sections')" bare class="!mb-0 w-full">
                    ...
                    >
                        {{ __('Load balancers') }}
                        @if ($lbCount > 0)
                            <span class="ml-1.5 inline-flex items-center rounded-full bg-brand-sand/70 px-1.5 py-0.5 text-[10px] font-semibold text-brand-moss ring-1 ring-brand-ink/10">{{ $lbCount }}</span>
                        @endif
                    </x-server-workspace-tab>
                    <x-server-workspace-tab
                        id="net-tab-networks"
                    ...
                    >
                        {{ __('Networks') }}
                        @if ($networkCount > 0)
                            <span class="ml-1.5 inline-flex items-center rounded-full bg-brand-sand/70 px-1.5 py-0.5 text-[10px] font-semibold text-brand-moss ring-1 ring-brand-ink/10">{{ $networkCount }}</span>
                        @endif
                    </x-server-workspace-tab>
