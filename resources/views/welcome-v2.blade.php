...
<head>
    ...
    <title>{{ config('app.name') }} – Infrastructure operations, in motion</title>
    <meta name="description" content="Provision, secure, and run servers across any cloud—organization-scoped, audit-ready, and fast. Watch a deploy happen.">
